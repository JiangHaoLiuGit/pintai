<template>
  <div class="renovation">
      ...
      <div class="renovation_right">
        ...
        <div class="phone_contant">
          ...
          <div class="renovation_center">
            ...
            <!-- icon展示区 -->
            <div
              class="banner_view_box"
              v-loading="icon_loading_drag"
              id="icon_id"
            >
              ...
              >
                ...
                >
                  <transition-group
                    style="display: flex; flex-wrap: wrap; padding-top: 20px"
                  >
                    <div
                      v-for="element in page"
                      :key="element.info_id"
                      :style="element.banner_view_item"
                      class="banner_view_item"
                    >
                      <el-image
            ...
            <div class="notice_view_box">
              <draggable
                ...
                group="people"
                animation="1000"
                @end="drag_notice_active_end"
              >
                <transition-group>
                  <div
                    v-for="element in configure_"
                    :key="element.id"
                    style="
                  ...
                  >
                    ...
                    <div v-if="element.type == 1" id="active_" class="active_k">
                      <div
                        ...
                        :style="
                          item.mould_type == '3' &&
                          item.category_name != '有品秒杀'
                            ? aaa
                            : ''
                        "
                      >
                        <div
                          v-show="item.category_name == '有品秒杀'"
                          class="seckill"
                        >
                          ...
                          <ul class="kkk">
                            <li
                              v-for="(ele, ele_index) in item.img"
                              :key="ele_index"
                            >
                              <el-image
                        ...
                        >
                          <div class="active_header">
                            ...
                            <div>
                              ...
                              style="width: 60px; height: 15px;margin-right:10px"
                              :src="item.icon_url"
                              fit="cover"
                            ></el-image>
                            <span>></span>
                        ...
                        >
                          ...
                          <ul class="kkk" v-if="item.img.length > 0">
                            <!-- <li v-if="item.img[0]&&item.img[0].img_url">
                                <el-image
                                  style="width:50px;height:60px;"
                                  :src="item.img[0].img_url"
                                  fit="cover"></el-image>
                              </li>
                              <li v-if="item.img[1]&&item.img[1].img_url">
                                <el-image
                                  style="width:50px;height:60px;"
                                  :src="item.img[1].img_url"
                                  fit="cover"></el-image>
                              </li> -->
                            <li v-for="(ite, ind) in item.img" :key="ind">
                              <el-image
                                style="width: 50px; height: 60px"
                                :src="ite.img_url"
                                fit="cover"
            ...
            <div class="product_view_box" id="product_id">
              <ul class="product_ul" :style="product_ul">
                <li
                  v-for="(item, index) in product_tag"
                  :key="index"
                  :style="index > 1 ? product_style : ''"
                  @click="pick_k(item)"
                >
                  {{ item.category_name }}
                </li>
              ...
              <div class="big_style">
                <div
                  ...
                  :key="index"
                  v-show="item.mould_type == 1"
                >
                  <img :src="item.img" alt="" />
                  <h5 :style="item.name_colour" v-show="item.show_name == 1">
                    {{ item.name }}
                  </h5>
                  <div class="big_contant">
                    ...
                    <span
                      v-show="item.show_product_price == 1"
                      :style="item.price_colour"
                      >￥158</span
                    >
                    ...
                    <div class="only_contant">
                      <div>
                        ...
                        <span
                          ...
                          "
                          v-show="item.show_market_price == 1"
                          >￥299</span
                        >
                      </div>
                      <div style="display: flex; margin-top: 10px">
                        <span class="span_o" v-show="item.show_purchase == 1"
                          >自购省钱</span
                        >
                        <span class="span_t" v-show="item.show_share == 1"
                          >分享赚钱</span
                        >
                      </div>
                    </div>
              ...
              <div class="double_style">
                ...
                <div>
                  <div
                    class="double_div"
                    v-for="(item, index) in product_list_copy"
                    :key="index + 9"
                    v-show="item.mould_type == 3"
                  >
                    <img :src="item.img" alt="" />
      ...
      <div class="renovation_edit">
        ...
        <div class="icon_edit" v-show="icon_edit_show">
          ...
          <el-form ref="icon_form" :model="icon_form" label-width="120px">
            ...
            <el-form-item label="操作：">
              ...
              <el-button type="primary" @click="edit_icon_sure"
                >保存更改</el-button
              >
            ...
            <el-col :span="24">
              ...
              >
                ...
                <el-table-column label="副图" width="150">
                  <template slot-scope="scope">
                    <el-image :src="scope.row.red_text" fit="cover"></el-image>
                  </template>
                </el-table-column>
        ...
        <div class="notice_edit" v-show="notice_edit_show">
          ...
          <el-form ref="notice_form" :model="notice_form" label-width="120px">
            ...
            <el-form-item>
              <el-button
                type="primary"
                @click="notice_add_sure"
                v-show="notice_add_show"
                >确 认</el-button
              >
              <el-button
                type="primary"
                @click="notice_save_sure"
                v-show="!notice_add_show"
                >保 存</el-button
              >
        ...
        <div class="product_edit" v-show="product_edit_show">
          ...
          <el-form ref="product_form" :model="product_form" label-width="120px">
            ...
            <el-form-item label="操作：">
              <el-button type="primary" @click="save_product_sure"
                >保存</el-button
              >
            </el-form-item>
            <div
                ...
                <el-table-column label="操作" width="400">
                  <template slot-scope="scope">
                    ...
                    <el-button
                      ...
                      icon="el-icon-bottom"
                      v-show="
                        scope.$index != product_tag.length - 1 &&
                        scope.$index > 1 &&
                        product_tag.length > 3
                      "
          ...
          <el-row :gutter="20" class="goodsindex-list">
            <el-col :span="24">
              ...
              >
                ...
                <el-table-column label="模板样式" prop="mould_name" width="120">
                </el-table-column>
    ...
    >
      <el-form :model="product_form_p">
        <el-form-item
          ...
          v-show="!product_form_p.ifAdd"
        >
          <el-input
            v-model="product_form_p.category_name"
            autocomplete="off"
            disabled
          ></el-input>
        </el-form-item>
        <el-form-item
          ...
          :label-width="formLabelWidth"
          v-show="
            product_form_p.category_name != '猜你喜欢' &&
            product_form_p.category_name != '热销爆款'
          "
        >
          <el-select
            v-model="product_form_p.category_id"
            placeholder="请选择营销分类"
          >
            <el-option
              v-for="item in market_category_list"
        ...
        <el-form-item label="链接地址：" :label-width="formLabelWidth">
          <el-input
            v-model="product_form_p.link_url"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="模板样式：" :label-width="formLabelWidth">
          <el-radio v-model="product_form_p.mould_type" label="1"
            >大图样式</el-radio
          >
          <el-radio v-model="product_form_p.mould_type" label="2"
            >单列样式</el-radio
          >
          <el-radio v-model="product_form_p.mould_type" label="3"
            >双列显示</el-radio
          >
          <el-radio v-model="product_form_p.mould_type" label="4"
            >三列显示</el-radio
          >
        </el-form-item>
        <el-form-item label="商品名称：" :label-width="formLabelWidth">
          <el-radio v-model="product_form_p.show_product_name" label="1"
            >显示</el-radio
          >
          <el-radio v-model="product_form_p.show_product_name" label="2"
            >不显示</el-radio
          >
        </el-form-item>
        ...
        <el-form-item label="销售价格：" :label-width="formLabelWidth">
          <el-radio v-model="product_form_p.show_product_price" label="1"
            >显示</el-radio
          >
          <el-radio v-model="product_form_p.show_product_price" label="2"
            >不显示</el-radio
          >
        </el-form-item>
        ...
        <el-form-item label="市场价：" :label-width="formLabelWidth">
          <el-radio v-model="product_form_p.show_market_price" label="1"
            >显示</el-radio
          >
          <el-radio v-model="product_form_p.show_market_price" label="2"
            >不显示</el-radio
          >
        </el-form-item>
        <el-form-item label="自购省钱：" :label-width="formLabelWidth">
          <el-radio v-model="product_form_p.show_purchase" label="1"
            >显示</el-radio
          >
          <el-radio v-model="product_form_p.show_purchase" label="2"
            >不显示</el-radio
          >
        </el-form-item>
        <el-form-item label="分享赚钱：" :label-width="formLabelWidth">
          <el-radio v-model="product_form_p.show_share" label="1"
            >显示</el-radio
          >
          <el-radio v-model="product_form_p.show_share" label="2"
            >不显示</el-radio
          >
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="add_" v-show="product_form_p.ifAdd"
          >添 加</el-button
        >
        <el-button type="primary" @click="save_" v-show="!product_form_p.ifAdd"
          >保 存</el-button
        >
      </div>
    </el-dialog>
    ...
    <el-dialog
      :title="active_title"
      :visible.sync="active_dialogFormVisible"
      class="dialogForm_active"
    >
      <el-form :model="active_from">
        <el-form-item
          label="营销分类(原)："
          :label-width="formLabelWidth"
          v-show="!active_from.ifAdd"
        >
          <el-input
            v-model="active_from.category_name"
            autocomplete="off"
            disabled
          ></el-input>
        </el-form-item>
        <el-form-item label="营销分类：" :label-width="formLabelWidth">
          <el-select
            v-model="active_from.category_id"
            placeholder="请选择营销分类"
            @change="change_active"
          >
            <el-option
              v-for="item in market_category_list"
              :key="item.id"
        ...
        <el-form-item label="模板样式：" :label-width="formLabelWidth">
          <el-radio v-model="active_from.mould_type" label="1"
            >大图滑动</el-radio
          >
          <el-radio v-model="active_from.mould_type" label="2"
            >小图滑动</el-radio
          >
          <el-radio v-model="active_from.mould_type" label="3"
            >双列小图显示</el-radio
          >
          <el-radio v-model="active_from.mould_type" label="4"
            >四列显示</el-radio
          >
          <el-radio v-model="active_from.mould_type" label="5"
            >双列大图显示</el-radio
          >
          <el-radio v-model="active_from.mould_type" label="6"
            >单列大图</el-radio
          >
        </el-form-item>
      ...
      <el-button size="small" type="primary" @click="add_table_img"
        >添加图片</el-button
      >
      <el-row :gutter="20" class="goodsindex-list">
        <el-col :span="24">
              ...
              <template slot-scope="scope">
                ...
                >
                  <el-button
                    size="small"
                    type="primary"
                    @click="add_active_img_(scope.$index, scope.row)"
                    >上传图片</el-button
                  >
                </el-upload>
                <el-button
...
export default {
  ...
  computed: {
    pages() {
      ...
      if (
        ...
        console.log(pages);
        return pages;
      } else if (that.icon_form.show_method == 1 && that.if_drag == true) {
        //单页排列  拖拽
        that.if_drag = false;
        that.myArray.forEach((item, index) => {
          const page = Math.floor(index / that.myArray.length);
        ...
        console.log(pages);
        return pages;
      } else if (that.show_method_srue == false && that.if_drag == false) {
        //无更改  无拖拽
        console.log(9999999999999999, that.icon_form);
        console.log(that.pages_copy);
        that.pages_copy.forEach((element_p) => {
          //将保存数据转为一维数组
        ...
        if (that.myArray.length != that.pages_copy.length) {
          //删除icon

          leg = true;
        } else {
          that.myArray.forEach((element, index) => {
            //判断列表数据与保存数据是否一致
            if (element.info_id != "") {
  ...
  methods: {
    ...
    edit_icon_sure() {
      ...
      that.iconList.forEach((ele) => {
        ...
        if (
          ...
          ele.color == "" ||
          ele.type == "" ||
          (ele.cate_name == undefined && ele.cate_id != "") ||
          (ele.cate_name == "" && ele.cate_id == "")
        ) {
          leg = true;
          return;
        }
      ...
      if (leg == true) {
        that.$message({
          message:
            "请将表格内容里的主图、按钮文字、按钮文字颜色、营销分类内容填写完整",
          type: "warning",
        });
        return;
      }
        ...
        .then((res_s) => {
          ...
          if (res_s.data.err_code == 0) {
            ...
            if (res_s.data.err_msg.list[0].type == 2) {
              ...
              res_s.data.err_msg.list[res_s.data.err_msg.list.length - 1]
                .type == 2
            ) {
              that.configure_ = [];
              that.configure_ = [
            ...
            res_s.data.err_msg.list.forEach((ele) => {
              if (ele.type == 2) {
                ...
                that.notice_timmer = setInterval(
                  that.startPlay,
                  parseInt(that.notice_form.sliding) * 1000
                );
              } else {
                ele.category_name = "";
                ele.mould_name = "";
    ...
    delete_active_(index, row) {
      ...
      that
        .$confirm(
          "此操作将删除名为" + row.category_name + "的营销活动,是否继续?",
          "提示",
          {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
    ...
    edit_active_p(index, row) {
      ...
      that.active_from.category_id = row.category_fid;
      ...
      if (this.active_table_err == false) {
        ...
        upload_img(fd)
          .then((res) => {
            console.log(res);
            if (res.data.err_code == 0) {
              that.active_from.diagram[that.active_table_index].image =
    ...
    active_add_() {
      ...
      //   return;
      // }
      if (that.active_from.diagram.length > 0) {
    ...
    active_save_() {
      ...
      that.market_category_list.forEach((element) => {
        ...
        if (
          ...
          that.active_from.category_name == element.show_product_name
        ) {
          that.active_from.category_id = element.id;
        }
      });
    ...
    delete_product(index, row) {
      ...
      that
        .$confirm(
          "此操作将删除名为: " + row.category_name + "的类别,是否继续?",
          "提示",
          {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
  ...
  .notice_view_box {
    ...
    .active_k {
      ...
      .active_box {
        ...
        // 双列大图显示
        .double_big_seckill,.double_bigs_seckill {
          width: 100%;
          background: #fefefe;
          border-radius: 20px;
          margin: 20px 0;
