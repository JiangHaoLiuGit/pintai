        ...
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column label="结算价(元)" width="120">
              <template slot-scope="scope">
                <el-input v-model="scope.row.prime_cost_price" @input="jie(scope.$index,scope.row)" disabled></el-input>
              </template>
            </el-table-column>
            <el-table-column label="销售价(元)" width="120">
              <template slot-scope="scope">
                <el-input v-model="scope.row.price" @input="shou(scope.$index,scope.row)" disabled></el-input>
              </template>
            </el-table-column>
