    ...
    <el-row :gutter="20" class="goodsindex-list2" style="margin: 0 0 0 0">
      <el-col :span="24">
        ...
        >
              ...
              <div v-if="spanArr[scope.$index]>0" class="clearfix" style="text-align: left">
                <div class="lt" style="width:80%">
                  ...
                  <div>
                    ...
                    <span style="margin-right:20px;">运营商：{{scope.row.store_id == "0"? "平台自营": scope.row.store_name? scope.row.store_name: "未知"}}</span>
                ...
                <div class="rt" style="width:20%;text-align: right;padding-top:10px;padding-right: 13px;">
                  ...
                  <el-tag type="danger" @click="lookRefund(scope.row)" style="cursor:pointer;" v-if="scope.row.refund_status != '0'">有退款</el-tag>
                  <!-- <el-button
                    size="mini"
                    type="primary"
          ...
          <el-table-column label="退款/退货" width="150">
            <template slot-scope="scope">
              <div v-if="scope.row.return_status == 0">退款状态: 未退款</div>
              <div v-else-if="scope.row.return_status == 1">退款状态: 部分退款</div>
              <div v-else-if="scope.row.return_status == 2">退款状态: 全部退款</div>
              <div v-else-if="scope.row.return_status == 3">退款状态: 部分退款完成</div>
              <div v-else-if="scope.row.return_status == 4">退款状态: 全部退款完成</div>
          ...
          <el-table-column label="订单总额" width="300">
            <template slot-scope="scope">
              <ul>
                <li style="text-align: left;font-size:15px;color: red;">
                    订单合计：{{ scope.row.should_price }}元
                </li>
          ...
          <el-table-column label="操作" width="100">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-if="scope.row.store_id == '0' && scope.row.status == 2  && scope.row.refund_status != 2"
                >发货</el-button
              >
              <el-button
                size="mini"
